...
class SwinTransformerBlock(layers.Layer):
    ...
    def __init__(self, dim, num_heads, window_size=7, shift_size=0,
        ...
        # Layer Nom
        self.norm1 = layers.BatchNormalization(epsilon=1e-6, name="norm1")
        ...
        # 第二个Layer Nom
        self.norm2 = layers.BatchNormalization(epsilon=1e-6, name="norm2")
...
def swin_tiny_patch4_window7_160(num_classes: int = 1000, **kwargs):
    model = SwinTransformer(patch_size=4,
                            ...
                            name="swin_tiny_patch4_window7_160",
                            **kwargs)
    return model
